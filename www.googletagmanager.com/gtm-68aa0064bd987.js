...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_measurementId": "G-Y1W4PRGJ0B",
    ...
    */
            ...
            if (va(a)) {
                ...
                switch (a[0]) {
                    ...
                    case "escape":
                        ...
                        d = String(d);
                        for (var t =
                                2; t < a.length; t++) oc[a[t]] && (d = oc[a[t]](d));
                        return d;
                    case "tag":
                        var u = a[1];
    ...
    var K = {
        ...
        ie = {},
        je = Object.freeze((ie[K.g.Z] = 1, ie[K.g.ef] = 1, ie[K.g.Rd] = 1, ie[K.g.jb] = 1, ie[K.g.T] = 1, ie[K.g.Oa] = 1, ie[K.g.Ca] = 1, ie[K.g.Pa] = 1, ie[K.g.fc] = 1, ie[K.g.Ic] = 1, ie[K.g.Ja] =
            1, ie[K.g.kb] = 1, ie[K.g.Jc] = 1, ie[K.g.W] = 1, ie[K.g.Ig] = 1, ie[K.g.Oc] = 1, ie[K.g.be] = 1, ie[K.g.ce] = 1, ie[K.g.de] = 1, ie[K.g.Xg] = 1, ie[K.g.Ya] = 1, ie[K.g.Zg] = 1, ie[K.g.ie] = 1, ie[K.g.rf] = 1, ie[K.g.pb] = 1, ie[K.g.qb] = 1, ie[K.g.za] = 1, ie[K.g.uf] = 1, ie[K.g.me] = 1, ie[K.g.Jb] = 1, ie[K.g.Ka] = 1, ie[K.g.Kb] = 1, ie[K.g.Tc] = 1, ie[K.g.Uc] = 1, ie[K.g.wf] = 1, ie[K.g.Vc] = 1, ie[K.g.Lb] = 1, ie[K.g.Mb] = 1, ie[K.g.qe] = 1, ie[K.g.La] = 1, ie[K.g.nd] = 1, ie));
    ...
    var ke = {},
        ...
        we = Object.freeze((ve[K.g.Z] = 1, ve[K.g.Rd] = 1, ve[K.g.Ba] = 1, ve[K.g.Fb] = 1, ve[K.g.ff] = 1, ve[K.g.Sd] = 1, ve[K.g.Td] = 1, ve[K.g.Ud] = 1, ve[K.g.T] = 1, ve[K.g.Vd] = 1, ve[K.g.Ia] = 1, ve[K.g.ya] = 1, ve[K.g.Oa] = 1, ve[K.g.Ca] = 1, ve[K.g.Pa] = 1, ve[K.g.Ja] = 1, ve[K.g.na] = 1, ve[K.g.Wd] = 1, ve[K.g.W] = 1, ve[K.g.pj] = 1, ve[K.g.Zd] = 1, ve[K.g.ae] = 1, ve[K.g.nf] = 1, ve[K.g.de] = 1, ve[K.g.pb] = 1, ve[K.g.qb] = 1, ve[K.g.Da] = 1, ve[K.g.Pc] = 1, ve[K.g.oa] = 1,
            ve[K.g.Aa] = 1, ve[K.g.ih] = 1, ve[K.g.jh] = 1, ve[K.g.kh] = 1, ve[K.g.lh] = 1, ve[K.g.Jb] = 1, ve[K.g.Ka] = 1, ve[K.g.Kb] = 1, ve[K.g.Tc] = 1, ve[K.g.Vc] = 1, ve[K.g.qa] = 1, ve[K.g.Lb] = 1, ve[K.g.Mb] = 1, ve[K.g.vb] = 1, ve[K.g.ra] = 1, ve[K.g.wa] = 1, ve[K.g.aa] = 1, ve)),
        xe = {},
    ...
    ze.md = Number("0") || 0;
    ze.da = "dataLayer";
    ze.Ki = "ChAI8NCBpwYQt5+cxZ7f1aFJEiQATU77VD/YPfI4n2DDHHcK8r0rc7gsImr6gZCfreJBrrWtktkaAstC";
    var Ce = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    a: {
        for (var lf = void 0, mf = void 0, nf = 0; lf === mf;)
            if (lf = Math.floor(2 * Math.random()), mf = Math.floor(2 * Math.random()), nf++, 20 < nf) break a;lf ? N[78] = !0 : N[79] = !0
    }
    ...
    var pf;
    try {
        pf = JSON.parse(Za("eyIwIjoiVVMiLCIxIjoiVVMtQ0EiLCIyIjpmYWxzZSwiMyI6IiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        J(123), of (2), pf = {}
    }
    var qf = function() {
        ...
        if (Jf(p, n, e, f)) {
            ...
            q && z.setTimeout(function() {
                if (l[b] === r && r.quiet) {
                    ...
                    var t = [b];
                    if (Mc(4))
                        for (var u in Ef) Ef.hasOwnProperty(u) && Ef[u] === b && t.push(u);
                    for (var v =
                            0; v < t.length; v++) Kf(a, t[v]);
                    a.notifyListeners();
                    ab("TAGGING", 2)
                }
            }, h)
    ...
    ca.update = function(a, b) {
        ...
        if (void 0 != b) {
            ...
            var f = this.getConsentState(a),
                h = [a];
            if (Mc(4))
                for (var l in Ef) Ef.hasOwnProperty(l) && Ef[l] === a && h.push(l);
            if (e.quiet) {
                e.quiet = !1;
    ...
    var Bh = function(a, b, c, d) {
        ...
        Eh = /[?&]($|#)/,
        Fh = function(a, b, c) {
            for (var d, e = a.search(Ch), f = 0, h, l = []; 0 <= (h = Bh(a, f, b, e));) l.push(a.substring(f,
    ...
    var Vh = function(a, b, c) {
            ...
            else m = 1 === l ? a.purpose && a.vendor ? Uh(a.purpose.legitimateInterests,
                b) && Uh(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
            return m
        },
        Uh = function(a, b) {
            return !(!a || !a[b])
        ...
        if ((!ai() || P(90)) && !a.active && Sh(b)) {
            ...
            try {
                b.addEventListener(function(c) {
                    if (0 !== c.internalErrorState) ci(a), di(a);
                    else {
                        ...
                        if (!1 === c.gdprApplies) {
                            var e = {},
                                f;
                            for (f in Yh) Yh.hasOwnProperty(f) &&
                                (e[f] = !0);
                            d = e;
    ...
    var ij, jj = function() {
        ...
        mj = function(a, b) {
            a && (b.h[K.g.Wc] = a.architecture, b.h[K.g.Xc] = a.bitness, a.fullVersionList && (b.h[K.g.Yc] = a.fullVersionList.map(function(c) {
                ...
                b.h[K.g.Zc] = a.mobile ? "1" : "0", b.h[K.g.ad] = a.model, b.h[K.g.bd] = a.platform, b.h[K.g.dd] = a.platformVersion, b.h[K.g.ed] = a.wow64 ? "1" : "0")
        };
    var nj = /:[0-9]+$/,
        ...
        sj = function(a, b, c, d, e) {
            ...
            "port" === b ? a.port = String(Number(a.hostname ? a.port : z.location.port) || ("http" === a.protocol ? 80 : "https" ===
                a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || z.location.hostname).replace(nj, "").toLowerCase());
            return rj(a, b, c, d, e)
        },
        rj = function(a, b, c, d, e) {
            var f, h = qj(a.protocol);
            b && (b = String(b).toLowerCase());
            switch (b) {
    ...
    function Lk(a, b, c, d, e) {
        ...
        if (!m && a.gb) {
            var q = a.gb[0],
                ...
                t = !1;
            if (!b)
                for (var u = Dk(r), v = 0; v < u.length; v++) u[v].R === q && u[v].labels &&
                    ...
                    if (void 0 !== Ak[f]) {
                        ...
                        if (l) {
                            ...
                            b: {
                                var p = m;
                                if (zi(z))
                                    for (var q = Ci(h, D.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r)
                                        if (Ok(q[r]) > p) {
                                            n = !0;
                                            break b
                                        }
                    ...
                    if (cl.test(d)) {
                        ...
                        if (b) {
                            ...
                            for (var m = 0; m < f.length; m++)
                                if (!f[m] || dl.test(f[m]) && ("AW" !== d || 1 !== m)) return
                        }
                        return {
                            id: a,
                            prefix: d,
    ...
    var qp = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        ...
        wp = function(a) {
            ...
            up() && (Ge ?
                J(116) : J(117), vp && (b = [], window.console && window.console.log && window.console.log("GTM blocked. See go/13687728.")));
            var c = b && Pa(Fa(b), rp),
    ...
    var Jp = {
        ...
        Op = function(a, b, c) {
            if (Jg && "config" === a && !(1 < el(b).J.length)) {
                ...
                h.length && (h.length && Jg && Hp.push(b + "*" + h.join(".")), ab("TAGGING", Jp[D.readyState] ||
                    14));
                d[b] = f
            }
        };
    ...
    function Kr(a, b) {
        if (!b) return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && Rc[c] && !De[String(Rc[c][nc.ia])]) return !0;
        return !1
    }
    var Mr = {};
    ...
    Ur.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length;) {
            ...
            var f = this.h[0],
                h = f.h;
            if (f.messageContext.deferrable) !h || Vr(this, h).B ? (f.messageContext.deferrable = !1, this.h.push(f)) : c.push(f), this.h.shift();
            else {
                switch (f.type) {
                    case "require":
    ...
    var Xr = function(a, b) {
            if ("require" !== b.type)
                if (b.h)
                    for (var c = Vr(a, b.h).M[b.type] || [], d = 0; d < c.length; d++) c[d]();
                else
                    for (var e in a.B)
                ...
                if (!(2 > a.length) && g(c)) {
                    ...
                    if (g(r) || va(r)) {
                        ...
                        var u = as(t, b.isGtmEvent),
                            ...
                            w = u.ol;
                        if (w.length)
                            for (var x = ks(q), y = 0; y < w.length; y++) {
    ...
    var xx = window,
        ...
        zx = function(a) {
            ...
            for (var d = yi("AMP_TOKEN", String(yx.cookie), !0), e = 0; e < d.length; e++)
    ...
    X.m.gaawc = ["google"],
        function() {
            (function(a) {
                ...
                if (!g(b) || 0 >= b.indexOf("-")) G(a.vtp_gtmOnFailure);
                else {
                    ...
                    a.vtp_enableSendToServerContainer &&
                        a.vtp_serverContainerUrl && (c[K.g.Lb] = a.vtp_serverContainerUrl, c[K.g.de] = !0);
    ...
    (function(a) {
        ...
        if (Me) a();
            ...
            var f = function(u) {
                    ...
                    x || (x = [],
                        z["google.tagmanager.debugui2.queue"] = x, Qb("https://" + ze.Pd + "/debug/bootstrap?id=" + jg.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + Xi()));
                    var y = {
        ...
        try {
            ...
            if (eg().canonical[b]) {
                ...
                Qp = !1;
                Rp = 0;
                if ("interactive" == D.readyState && !D.createEventObject || "complete" == D.readyState) Tp();
                else {
